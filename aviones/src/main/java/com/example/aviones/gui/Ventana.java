...
public class Ventana extends JFrame implements Runnable {
    ...
    public void paint(Graphics g) {
        ...
        add(boton);
        super.paint(g);
        Image k=Toolkit.getDefaultToolkit().getImage("C:\\Users\\cbocc\\Documents\\GitHub\\AvionesObserver\\aviones\\png\\field.jpeg");
        g.drawImage(k, 0, 0, 2500, 1000, this);
        Font f=new Font("Ariel Black", Font.BOLD, 20);
        g.setFont(f);

        Image j=Toolkit.getDefaultToolkit().getImage("C:\\Users\\cbocc\\Documents\\GitHub\\AvionesObserver\\aviones\\png\\plane.png");
